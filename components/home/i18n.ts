...
const zhCN = {
  ...
  "mode.removeBackground.label": "抠图",
  ...
  "queue.title": "图片",
  "queue.count": "{count} 张",
  "queue.dropHint": "拖放图片到这里",
  "format.outputTitle": "输出格式",
  "format.compressionTitle": "输出格式",
  "format.transparentTitle": "输出格式",
  "quality.title": "质量",
  ...
  "export.title": "导出",
  "export.noFolder": "未选择文件夹",
  "export.chooseFolder": "选择位置",
  "export.batch": "导出全部",
  "export.all": "导出全部",
  "export.outputTo": "输出到：{path}",
  "export.outputUnset": "未选择文件夹",
  "export.historyTitle": "导出记录",
  "export.latestBatch": "最近一批：",
  "export.emptyHistory": "暂无导出记录",
  ...
  "resize.presetsTitle": "预设",
  "resize.maximumSizeTitle": "尺寸上限（px）",
  "resize.maximumWidth": "宽度",
  "resize.maximumHeight": "高度",
  "resize.lockRatio": "联动宽高",
  "resize.previewTitle": "尺寸调整预览",
  "resize.preserveRatio": "原始比例",
  ...
  "convert.originalSize": "文件大小 {size}",
  "convert.outputFormat": "导出格式：{format}",
  "convert.estimatedSize": "预计 {size}",
  "convert.exportedSize": "已导出 {size}",
  "convert.calculating": "估算中…",
  "convert.noImage": "选择图片",
  ...
  "layout.matchedLabel": "结果",
  "layout.autoScale": "自动缩放 {value}%",
  "layout.finalScale": "缩放 {value}%",
  "layout.offset": "X {x} · Y {y} px",
...
const enUS = defineTranslation({
  ...
  "mode.removeBackground.label": "Remove background",
  ...
  "queue.title": "Images",
  "queue.count": "{count}",
  "queue.dropHint": "Drop images here",
  "format.outputTitle": "Output format",
  "format.compressionTitle": "Output format",
  "format.transparentTitle": "Output format",
  ...
  "export.chooseFolder": "Choose location",
  "export.batch": "Export all",
  "export.all": "Export all",
  "export.outputTo": "Output to: {path}",
  "export.outputUnset": "No folder selected",
  "export.historyTitle": "Export history",
  "export.latestBatch": "Latest batch: ",
  "export.emptyHistory": "No exports yet",
  ...
  "crop.editorHint": "Drag to select · Use corners to resize",
  ...
  "resize.presetsTitle": "Presets",
  "resize.maximumSizeTitle": "Size limit (px)",
  "resize.maximumWidth": "Width",
  "resize.maximumHeight": "Height",
  "resize.lockRatio": "Link dimensions",
  "resize.previewTitle": "Resize preview",
  "resize.preserveRatio": "Original ratio",
  ...
  "convert.originalSize": "File size {size}",
  "convert.outputFormat": "Output format: {format}",
  "convert.estimatedSize": "Estimated {size}",
  "convert.exportedSize": "Exported {size}",
  "convert.calculating": "Estimating…",
  "convert.noImage": "Select an image",
  ...
  "layout.previewTitle": "Match preview",
  "layout.target": "{name}",
  ...
  "layout.matchedLabel": "Result",
  "layout.autoScale": "Auto scale {value}%",
  "layout.finalScale": "Scale {value}%",
  "layout.offset": "X {x} · Y {y} px",
